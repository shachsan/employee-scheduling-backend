...
# CalendarEvent.create(event_date:'2019/02/01', event:'Pay Day')
# CalendarEvent.create(event_date:'2019/02/15', event:'Pay Day')
# CalendarEvent.create(event_date:'2019/03/01', event:'Pay Day')
# CalendarEvent.create(event_date:'2019/03/15', event:'Pay Day')
# CalendarEvent.create(event_date:'2019/02/14', event:"Valentine's Day")
# CalendarEvent.create(event_date:'2019/02/18', event:"President's Day")
# CalendarEvent.create(event_date:'2019/02/09', event:'National Pizza Day')
# CalendarEvent.create(event_date:'2019/02/10', event:'New Hire Open House')
# CalendarEvent.create(event_date:'2019/02/20', event:'Podcast')
# CalendarEvent.create(event_date:'2019/02/24', event:'Emp Review Start')
